...
* [Open an issue](https://github.com/briandfoy/brians_perl6_modules_travis_config/issue) in GitHub.

* [Send a Pull Request](https://github.com/briandfoy/brians_perl6_modules_travis_config/pulls) in a new branch. We can always merge it to master later.
